Once a node has been commissioned (see [Commission nodes](nodes-commission.md)) the next logical step is to *deploy* it. Deploying a node means, effectively, to install an operating system on it.
