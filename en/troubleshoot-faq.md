...
When deployment fails the [Rescue mode](intro-concepts.md#heading--rescue-mode) action can be used to boot ephemerally into the node, followed by an investigation.
